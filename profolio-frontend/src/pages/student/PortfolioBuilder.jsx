...
import {
  ...
  faPlus, faTrash, faPen, faCode, faCertificate, 
  faTrophy, faChartLine, faBriefcase, faWandMagicSparkles, 
  faRightFromBracket, faSpinner, faArrowRight, faDumbbell, faClipboardList, 
